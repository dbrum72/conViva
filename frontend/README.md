...
Execute `npm install`, `npm run dev`. Valide com `npm test` e `npm run build`. A configuração local usa a API em http://127.0.0.1:8010/api e a interface em http://127.0.0.1:5186.
